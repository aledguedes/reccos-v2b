...
public class TeamServiceImpl implements TeamService {
	...
	public TeamResponse TeamById(Long team_id) {
		return teamRepository.findById(team_id).map(teamMapper::toTeamResponse).orElseThrow(TeamNotFoundException::new);
	}
	...
	public TeamResponse updateTeam(TeamRequest teamRequest, Long team_id) {
		var refree = teamRepository.findById(team_id).orElseThrow(TeamNotFoundException::new);
